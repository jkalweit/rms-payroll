...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(161), __webpack_require__(131), __webpack_require__(1)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, SyncNode_1, SyncView_1, moment) {
    "use strict";
    var ShiftView = (function (_super) {
        __extends(ShiftView, _super);
        function ShiftView() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.area = _this.append({ tag: "span", style: { display: "inline-block", width: "75px" } });
            _this.position = _this.append({ tag: "span", style: { display: "inline-block", width: "100px" } });
            _this.name = _this.append({ tag: "span", style: { display: "inline-block", width: "150px" } });
            _this.day = _this.append({ tag: "span", style: { display: "inline-block", width: "100px" } });
            _this.hours = _this.append({ tag: "span", style: { display: "inline-block", width: "75px" } });
            _this.clockIn = _this.append({ tag: "span", style: { display: "inline-block", width: "75px" } });
            _this.clockOut = _this.append({ tag: "span", style: { display: "inline-block", width: "75px" } });
            return _this;
        }
        ShiftView.prototype.duration = function () {
        ...
        ShiftView.prototype.render = function () {
            var shift = this.data.shift;
    ...
    var DayView = (function (_super) {
        ...
        function DayView() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.title = _this.append({ tag: "p" });
            _this.list = _this.appendView(new SyncView_1.SyncList({ item: ShiftView, sortField: "startDate", style: { marginTop: "1em" } }));
            return _this;
        }
        DayView.prototype.render = function () {
            this.title.innerHTML = moment(this.data.startDate).format("dddd");
            this.list.update(this.data.shifts);
        };
        return DayView;
    }(SyncView_1.SyncView));
    var ByEmployeeView = (function (_super) {
        __extends(ByEmployeeView, _super);
        function ByEmployeeView() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.s = _this.style({ marginLeft: "2em" });
            _this.name = _this.append({ tag: "h4" });
            _this.list = _this.appendView(new SyncView_1.SyncList({ item: ShiftView, sortField: "shift.clockIn", style: { marginTop: "1em" } }));
            return _this;
        }
        ByEmployeeView.prototype.render = function () {
            this.name.innerHTML = this.data.key;
            this.list.update(this.data.shifts);
        };
        return ByEmployeeView;
    }(SyncView_1.SyncView));
    var WeekView = (function (_super) {
        __extends(WeekView, _super);
        function WeekView() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.s = _this.style({ width: "100%" });
            _this.text = _this.append({ tag: "h3" });
            //list = this.appendView(new SyncList({ item: DayView, sortField: "startDate", style: { marginTop: "1em" }}));
            _this.list = _this.appendView(new SyncView_1.SyncList({ item: ByEmployeeView, sortField: "key", style: { marginTop: "1em" } }));
            return _this;
        }
        WeekView.prototype.render = function () {
            this.text.innerHTML = moment(this.data.startDate).format("dddd MMM Do YYYY");
            var grouped = {};
            SyncView_1.SyncUtils.forEach(this.data.days, function (day) {
                SyncView_1.SyncUtils.forEach(day.shifts, function (shift) {
                    if (shift.name.trim() !== "") {
                        if (!grouped[shift.name])
                            grouped[shift.name] = { key: shift.name, shifts: {} };
                        var tempKey = SyncNode_1.SyncNode.guidShort();
                        grouped[shift.name].shifts[tempKey] = { key: tempKey, shift: shift };
                    }
                });
            });
            console.log("grouped", grouped);
            this.list.update(grouped);
        };
        return WeekView;
    }(SyncView_1.SyncView));
    var WeeksView = (function (_super) {
        __extends(WeeksView, _super);
        function WeeksView() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.s = _this.style({ width: "100%" });
            _this.title = _this.append({ tag: "h1", innerHTML: "Payroll", style: { color: "#009" } });
            _this.list = _this.appendView(new SyncView_1.SyncList({ item: WeekView, sortField: "startDate", sortReversed: true, style: { marginTop: "1em" } }));
            return _this;
        }
        WeeksView.prototype.render = function () {
            var filtered = SyncView_1.SyncUtils.filterMap(this.data.weeks, function (week) {
    ...
    var MainView = (function (_super) {
        ...
        function MainView() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.list = _this.appendView(new WeeksView());
            return _this;
        }
...
var sliceBuffer = __webpack_require__(133);
var after = __webpack_require__(132);
var utf8 = __webpack_require__(163);

var base64encoder;
if (global && global.ArrayBuffer) {
  base64encoder = __webpack_require__(135);
}
...
var Blob = __webpack_require__(136);
...
var debug = __webpack_require__(156)('socket.io-parser');
var json = __webpack_require__(147);
var Emitter = __webpack_require__(155);
var binary = __webpack_require__(154);
...
var XHR = __webpack_require__(142);
var JSONP = __webpack_require__(141);
var websocket = __webpack_require__(143);
...
var Socket = __webpack_require__(128);
var Emitter = __webpack_require__(5);
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(161)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, SyncNode_1) {
    "use strict";
    var SyncView = (function (_super) {
        ...
        SyncView.prototype.append = function (spec) {
            if (spec === void 0) { spec = {}; }
            var el = document.createElement(spec.tag || "div");
        ...
        SyncView.prototype.appendView = function (view) {
            view.init();
    ...
    var SyncApp = (function () {
        ...
        SyncApp.prototype.start = function () {
            ...
            window.addEventListener('load', function () {
                ...
                var sync = new SyncNode_1.SyncNodeSocket('/data', {});
...
if (typeof window === 'undefined') {
  try {
    NodeWebSocket = __webpack_require__(164);
  } catch (e) { }
}
...
;(function () {
  ...
  var isLoader = "function" === "function" && __webpack_require__(162);
...
exports.Socket = __webpack_require__(128);
...
exports.enable = enable;
exports.enabled = enabled;
exports.humanize = __webpack_require__(159);
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(152)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, io) {
    "use strict";
